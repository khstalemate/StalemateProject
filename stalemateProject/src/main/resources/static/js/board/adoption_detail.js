  ...
  .then(replyList => {
    ...
    for(let reply of replyList) {
      ...
      if(loginMemberNo != null && loginMemberNo == reply.memberNo) {
        const updateBtnBody = document.createElement("div");
        ...
        const deleteBtnBody = document.createElement("div");
        ...
        updateBtnBody.append(updateBtn);
        deleteBtnBody.append(deleteBtn);

        row.append(updateBtnBody, deleteBtnBody);
      }
